...
const Skills: React.FC = () => {
  ...
  const skillCategories: SkillCategory[] = [
    ...
    },
    {
      ...
      skills: ['Pytorch', 'Tensorflow', 'Scikit-Learn', 'OpenCV', 'Pandas', 'Pyspark', 'Langchain', 'HuggingFace', 'Autogen', 'Langflow'],
      color: 'from-green-500 to-emerald-500'
    },
    {
      title: 'Databases & Cloud',
      icon: <Database className="w-6 h-6" />,
      skills: ['MongoDB', 'MySQL', 'Pinecone','Snowflake'],
      color: 'from-purple-500 to-violet-500'
    },
    {
      title: 'Tools & Technologies',
      icon: <Wrench className="w-6 h-6" />,
      skills: ['Git/GitHub', 'VS Code', 'n8n', 'Docker', 'Anaconda'],
  ...
  return (
    <section id="skills" className="py-20 relative bg-[#F5F1E8]">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="text-center">
            ...
            >
              <Brain className="w-5 h-5 text-[#4F7DF3]" />
          ...
          >
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { label: 'Languages', count: 4, icon: Code },
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="text-3xl font-bold bg-gradient-to-r from-[#4F7DF3] to-[#6B8DF5] bg-clip-text text-transparent mb-1"
