...
//       icon: Mail,
//       label: 'Email',
//       value: 'krishnashandilyad@gmail.com',
//       href: 'mailto:krishnashandilyad@gmail.com',
...
//       icon: Linkedin,
//       label: 'LinkedIn',
//       href: 'https://www.linkedin.com/in/shandilya-k-764b9724b/'
//     },
//     {
//       icon: ExternalLink,
//       label: 'LeetCode',
//       href: 'https://leetcode.com/u/Shandilya_K/'
//     }
//   ];
...
const socialLinks = [
  ...
  },
  {
    icon: BarChart3,
    label: 'Kaggle',
    href: 'https://www.kaggle.com/shandilyakrishna',
  },
];
  ...
  return (
    <section id="contact" className="py-20 relative overflow-hidden bg-[#F5F1E8]">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-14">
            <div className="inline-flex items-center space-x-2 bg-blue-500/10 border border-blue-500/30 rounded-full px-6 py-2 mb-6">
              <MessageCircle className="w-4 h-4 text-[#4F7DF3]" />
              <span className="text-[#4F7DF3] text-sm font-medium">
                Get in Touch
              </span>
            </div>
          ...
          <motion.div variants={itemVariants} className="space-y-4 mb-12">
            {contactInfo.map((info, index) => (
              <motion.a
                ...
                className="flex items-center space-x-4 bg-[#ECE7DD] border border-[#D6CFC4] rounded-xl p-4 text-left hover:shadow-md transition-all"
              >
                <div
                ...
                <div>
                  ...
                  <p className="text-[#2E2E2E] font-medium">{info.value}</p>
                </div>
              </motion.a>
            ))}
          </motion.div>
          ...
          <motion.div variants={itemVariants}>
            <h3 className="text-xl font-semibold text-[#2E2E2E] mb-6">
              Follow Me
            </h3>
            <div className="flex justify-center space-x-6">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  whileHover={{ scale: 1.15, rotate: 360 }}
                  whileTap={{ scale: 0.9 }}
                  className="w-14 h-14 bg-[#ECE7DD] border border-[#D6CFC4] rounded-xl flex items-center justify-center hover:shadow-md transition-all"
                  aria-label={social.label}
                >
                  <social.icon className="w-5 h-5 text-[#4F7DF3]" />
                </motion.a>
              ))}
            </div>
          </motion.div>
